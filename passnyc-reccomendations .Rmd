...
El primer paso en la construccion de modelos de ML es el preprocesamiento de datos. Usualmente nos encontraremos con diversas fuentes de datos que contienen informacion valiosa para el modelo. Una de las ventajas de Data Science es la capacidad de manejar cantidades grandes de datos, por lo que tomaremos informacion de 11 bases de datos publicas de Nueva York para realizar nuestro modelo.
...
2) __¿Los estudiantes de cuales escuelas públicas tienen menos probabilidades de estar subrepresentados en el proceso de solicitud?__

***

### 2.1 Diferencias demográficas entre escuelas representativas y no representativas
En un año típico, alrededor de 25,000 estudiantes toman SHSAT, el examen de admisión para las escuelas secundarias especializadas, y solicitan admisión a SPHS, lo que representa 1/3 del total de estudiantes en la ciudad de Nueva York. Sin embargo, las ofertas no se distribuyen equitativamente entre los estudiantes de diferentes escuelas intermedias. En 2018, las 10 mejores escuelas intermedias con la mayoría de los estudiantes admitidos en SPHS representan el 25% de las ofertas totales [2].
...
FLa figura 1 ilustra que la proporción de género de las escuelas representativas y no representativas muestra una __distribución similar centrada en el 49% .__ 
...
diversity_cor <- cor.test(diversity_tbl$economic_need_index,
                          ...
                          conf.level = 0.95)
```
El diagrama de dispersión anterior visualiza la correlación positiva (r = 0.77, p <0.01) entre el Índice de Necesidad Económica y el % de estudiantes afroamericanos e hispanos. Las escuelas representativas con más estudiantes admitidos en SPHS (<font color="#53c7f0">__larger-sized blue points__</font>) tienden a tener una necesidad económica de baja a media y una menor proporción de estudiantes afroamericanos o hispanos, mientras que un notable número de escuelas no representativas (<font color="#707070">__gray points__</font>) se agrupan alrededor de la esquina superior derecha del diagrama. En otras palabras, los estudiantes de estas escuelas no representativas son en su mayoría estudiantes hispanos o afroamericanos de bajos ingresos que están subrepresentados en SPHS.
...
<center><h4>K-means Clusters para el Top 25% de Escuelas Intermedas con el Puntaje de Subrepresentación más alto</h4></center>
...
Simulacion de budget:
bajarlo a dinero. 
ROI?
que pasaria si los reparto de forma equitativa?
como si los retorno focalizado?
cuanto se ha ahorrado?
cual es la penetracion? 

poner alguna metrica. 


***

### 4.1 Recomendacion 1: Intervencion en el campus para 5 escuelkas en el Cluster A
